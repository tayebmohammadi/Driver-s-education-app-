...
export const brokenProcessSteps = [
  "Driver ed app",
  "DMV website",
  "Phone calls",
  "School websites",
...
export const problemItems = [
  {
    title: "Too many tabs",
    description: "Rules, forms, and schools live in different places.",
  },
  {
    title: "Phone tag",
    description: "Open lesson times rarely show up online.",
  },
  {
    title: "Hard to compare",
    description: "Price, language, and availability aren't side by side.",
  },
  {
    title: "Lost progress",
    description: "Study hours and lesson history never meet in one view.",
  },
];
